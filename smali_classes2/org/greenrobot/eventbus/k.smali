...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/greenrobot/eventbus/k;->d:Ljava/util/Map;
...
.method constructor <init>(Ljava/util/List;ZZ)V
    ...
    .line 50
    iput-object p1, p0, Lorg/greenrobot/eventbus/k;->e:Ljava/util/List;

    .line 51
    iput-boolean p2, p0, Lorg/greenrobot/eventbus/k;->f:Z

    .line 52
    iput-boolean p3, p0, Lorg/greenrobot/eventbus/k;->g:Z
...
.method static a()V
    ...
    .line 188
    sget-object v0, Lorg/greenrobot/eventbus/k;->d:Ljava/util/Map;
...
.method private b(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 76
    invoke-direct {p0}, Lorg/greenrobot/eventbus/k;->b()Lorg/greenrobot/eventbus/k$a;
    ...
    .line 79
    invoke-direct {p0, v0}, Lorg/greenrobot/eventbus/k;->b(Lorg/greenrobot/eventbus/k$a;)Lorg/greenrobot/eventbus/a/c;

    move-result-object p1

    iput-object p1, v0, Lorg/greenrobot/eventbus/k$a;->h:Lorg/greenrobot/eventbus/a/c;

    .line 80
    iget-object p1, v0, Lorg/greenrobot/eventbus/k$a;->h:Lorg/greenrobot/eventbus/a/c;
    ...
    invoke-interface {p1}, Lorg/greenrobot/eventbus/a/c;->getSubscriberMethods()[Lorg/greenrobot/eventbus/j;
...
.method private b(Lorg/greenrobot/eventbus/k$a;)Lorg/greenrobot/eventbus/a/c;
    .locals 3

    .line 123
    iget-object v0, p1, Lorg/greenrobot/eventbus/k$a;->h:Lorg/greenrobot/eventbus/a/c;

    if-eqz v0, :cond_0

    iget-object v0, p1, Lorg/greenrobot/eventbus/k$a;->h:Lorg/greenrobot/eventbus/a/c;

    invoke-interface {v0}, Lorg/greenrobot/eventbus/a/c;->getSuperSubscriberInfo()Lorg/greenrobot/eventbus/a/c;
    ...
    invoke-interface {v0}, Lorg/greenrobot/eventbus/a/c;->getSubscriberClass()Ljava/lang/Class;
    ...
    .line 129
    :cond_0
    iget-object v0, p0, Lorg/greenrobot/eventbus/k;->e:Ljava/util/List;
    ...
    invoke-interface {v1, v2}, Lorg/greenrobot/eventbus/a/d;->getSubscriberInfo(Ljava/lang/Class;)Lorg/greenrobot/eventbus/a/c;
...
.method private b()Lorg/greenrobot/eventbus/k$a;
    .locals 5
...
.method private c(Lorg/greenrobot/eventbus/k$a;)V
    ...
    .line 174
    :cond_0
    iget-boolean v7, p0, Lorg/greenrobot/eventbus/k;->f:Z
    ...
    .line 179
    :cond_1
    iget-boolean v5, p0, Lorg/greenrobot/eventbus/k;->f:Z
...
.method a(Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 61
    :cond_0
    iget-boolean v0, p0, Lorg/greenrobot/eventbus/k;->g:Z
    ...
    .line 70
    :cond_2
    sget-object v1, Lorg/greenrobot/eventbus/k;->d:Ljava/util/Map;
