...
.field private static final synthetic c:[Lorg/xutils/http/cookie/DbCookieStore;


# instance fields
.field private final db:Lorg/xutils/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/xutils/http/cookie/DbCookieStore;->c:[Lorg/xutils/http/cookie/DbCookieStore;
...
.method private constructor <init>(Ljava/lang/String;I)V
    ...
    .line 30
    new-instance p1, Lorg/xutils/common/task/a;

    const/4 p2, 0x1

    invoke-direct {p1, p2, p2}, Lorg/xutils/common/task/a;-><init>(IZ)V
    ...
    invoke-virtual {p1}, Lorg/xutils/config/DbConfigs;->getConfig()Lorg/xutils/b$a;

    move-result-object p1

    invoke-static {p1}, Lorg/xutils/g;->getDb(Lorg/xutils/b$a;)Lorg/xutils/b;

    move-result-object p1

    iput-object p1, p0, Lorg/xutils/http/cookie/DbCookieStore;->db:Lorg/xutils/b;

    .line 39
    :try_start_0
    iget-object p1, p0, Lorg/xutils/http/cookie/DbCookieStore;->db:Lorg/xutils/b;
    ...
    invoke-interface {p1, p2, v0}, Lorg/xutils/b;->delete(Ljava/lang/Class;Lorg/xutils/db/sqlite/c;)I
    :try_end_0
...
.method static synthetic access$100(Lorg/xutils/http/cookie/DbCookieStore;)Lorg/xutils/b;
    .locals 0

    .line 25
    iget-object p0, p0, Lorg/xutils/http/cookie/DbCookieStore;->db:Lorg/xutils/b;
...
.method public static values()[Lorg/xutils/http/cookie/DbCookieStore;
    ...
    .line 25
    sget-object v0, Lorg/xutils/http/cookie/DbCookieStore;->c:[Lorg/xutils/http/cookie/DbCookieStore;
...
.method public add(Ljava/net/URI;Ljava/net/HttpCookie;)V
    ...
    .line 57
    :try_start_0
    iget-object v0, p0, Lorg/xutils/http/cookie/DbCookieStore;->db:Lorg/xutils/b;
...
.method public get(Ljava/net/URI;)Ljava/util/List;
    ...
    .line 86
    :try_start_0
    iget-object v1, p0, Lorg/xutils/http/cookie/DbCookieStore;->db:Lorg/xutils/b;
    ...
    .line 92
    invoke-static {v4, v5, v3}, Lorg/xutils/db/sqlite/c;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;
    ...
    invoke-virtual {v4, v5, v6, v7}, Lorg/xutils/db/sqlite/c;->or(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;
    ...
    .line 98
    invoke-virtual {v4, v5, v6, v3}, Lorg/xutils/db/sqlite/c;->or(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;

    .line 101
    :cond_1
    invoke-virtual {v2, v4}, Lorg/xutils/db/sqlite/c;->and(Lorg/xutils/db/sqlite/c;)Lorg/xutils/db/sqlite/c;
    ...
    invoke-virtual {v2, v3, v4, p1}, Lorg/xutils/db/sqlite/c;->or(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;

    .line 120
    invoke-virtual {v1, v2}, Lorg/xutils/db/d;->where(Lorg/xutils/db/sqlite/c;)Lorg/xutils/db/d;
...
.method public getCookies()Ljava/util/List;
    ...
    invoke-interface {v1, v2}, Lorg/xutils/b;->findAll(Ljava/lang/Class;)Ljava/util/List;
...
.method public getURIs()Ljava/util/List;
    ...
    invoke-virtual {v1, v2}, Lorg/xutils/db/d;->select([Ljava/lang/String;)Lorg/xutils/db/c;

    move-result-object v1

    invoke-virtual {v1}, Lorg/xutils/db/c;->findAll()Ljava/util/List;
    ...
    check-cast v2, Lorg/xutils/db/b/d;

    const-string v3, "uri"

    .line 171
    invoke-virtual {v2, v3}, Lorg/xutils/db/b/d;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4, v3}, Lorg/xutils/common/a/f;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_2

    .line 178
    :try_start_3
    iget-object v3, p0, Lorg/xutils/http/cookie/DbCookieStore;->db:Lorg/xutils/b;
    ...
    invoke-static {v5, v6, v2}, Lorg/xutils/db/sqlite/c;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;

    move-result-object v2

    invoke-interface {v3, v4, v2}, Lorg/xutils/b;->delete(Ljava/lang/Class;Lorg/xutils/db/sqlite/c;)I
    :try_end_3
...
.method public remove(Ljava/net/URI;Ljava/net/HttpCookie;)Z
    ...
    invoke-static {v1, v2, v3}, Lorg/xutils/db/sqlite/c;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;
    ...
    .line 209
    invoke-virtual {v1, v3, v4, v2}, Lorg/xutils/db/sqlite/c;->and(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;
    ...
    .line 217
    invoke-virtual {v1, v2, v3, p2}, Lorg/xutils/db/sqlite/c;->and(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)Lorg/xutils/db/sqlite/c;

    .line 220
    :cond_3
    iget-object p2, p0, Lorg/xutils/http/cookie/DbCookieStore;->db:Lorg/xutils/b;

    const-class v2, Lorg/xutils/http/cookie/a;

    invoke-interface {p2, v2, v1}, Lorg/xutils/b;->delete(Ljava/lang/Class;Lorg/xutils/db/sqlite/c;)I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeAll()Z
    ...
    invoke-interface {v0, v1}, Lorg/xutils/b;->delete(Ljava/lang/Class;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
