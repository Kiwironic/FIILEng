.class Lcom/baidu/speech/VoiceRecognitionService$MyListener;
...
# instance fields
.field mListener:Landroid/speech/RecognitionService$Callback;
...
.method constructor <init>(Lcom/baidu/speech/VoiceRecognitionService;)V
    ...
    iput-object p1, p0, Lcom/baidu/speech/VoiceRecognitionService$MyListener;->this$0:Lcom/baidu/speech/VoiceRecognitionService;
...
.method private final callbackOnEvent(Landroid/speech/RecognitionService$Callback;ILandroid/os/Bundle;)V
    ...
    invoke-static {}, Lcom/baidu/speech/VoiceRecognitionService;->access$200()Ljava/util/logging/Logger;
...
.method public onEvent(Ljava/lang/String;Ljava/lang/String;[BII)V
    ...
    iget-object p4, p0, Lcom/baidu/speech/VoiceRecognitionService$MyListener;->mListener:Landroid/speech/RecognitionService$Callback;
    ...
    iget-object p2, p0, Lcom/baidu/speech/VoiceRecognitionService$MyListener;->this$0:Lcom/baidu/speech/VoiceRecognitionService;

    invoke-static {p2, p1}, Lcom/baidu/speech/VoiceRecognitionService;->access$002(Lcom/baidu/speech/VoiceRecognitionService;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-direct {p0, p4, p2, p1}, Lcom/baidu/speech/VoiceRecognitionService$MyListener;->callbackOnEvent(Landroid/speech/RecognitionService$Callback;ILandroid/os/Bundle;)V
    ...
    invoke-direct {p0, p4, p1, p2}, Lcom/baidu/speech/VoiceRecognitionService$MyListener;->callbackOnEvent(Landroid/speech/RecognitionService$Callback;ILandroid/os/Bundle;)V

    return-void

    :cond_9
    iget-object p1, p0, Lcom/baidu/speech/VoiceRecognitionService$MyListener;->this$0:Lcom/baidu/speech/VoiceRecognitionService;

    invoke-static {p1}, Lcom/baidu/speech/VoiceRecognitionService;->access$100(Lcom/baidu/speech/VoiceRecognitionService;)Z
    ...
    invoke-static {p1}, Lcom/baidu/speech/VoiceRecognitionService;->access$000(Lcom/baidu/speech/VoiceRecognitionService;)Landroid/os/Bundle;
    ...
    :goto_0
    invoke-static {p1, p5}, Lcom/baidu/speech/VoiceRecognitionService;->access$002(Lcom/baidu/speech/VoiceRecognitionService;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public setCallbackListener(Landroid/speech/RecognitionService$Callback;)V
    ...
    iput-object p1, p0, Lcom/baidu/speech/VoiceRecognitionService$MyListener;->mListener:Landroid/speech/RecognitionService$Callback;
