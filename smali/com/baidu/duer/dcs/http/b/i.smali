.class public Lcom/baidu/duer/dcs/http/b/i;
...
# static fields
.field private static final a:Ljava/lang/String; = "TurbonetRequestImpl"


# instance fields
.field private final b:Lcom/baidu/duer/dcs/http/b/c;
...
.method public constructor <init>()V
    ...
    .line 56
    new-instance v0, Lcom/baidu/duer/dcs/http/b/c;

    invoke-direct {v0}, Lcom/baidu/duer/dcs/http/b/c;-><init>()V

    iput-object v0, p0, Lcom/baidu/duer/dcs/http/b/i;->b:Lcom/baidu/duer/dcs/http/b/c;
    ...
    iput-object v0, p0, Lcom/baidu/duer/dcs/http/b/i;->c:Ljava/util/concurrent/Executor;

    return-void
.end method

.method static synthetic a(Lcom/baidu/duer/dcs/http/b/i;)Ljava/lang/String;
    .locals 0

    .line 50
    iget-object p0, p0, Lcom/baidu/duer/dcs/http/b/i;->d:Ljava/lang/String;
...
.method public cancelRequest(Ljava/lang/Object;)V
    ...
    .line 247
    iget-object v0, p0, Lcom/baidu/duer/dcs/http/b/i;->b:Lcom/baidu/duer/dcs/http/b/c;

    invoke-virtual {v0, p1}, Lcom/baidu/duer/dcs/http/b/c;->cancelByTag(Ljava/lang/Object;)V
...
.method public getDirectives(JLcom/baidu/duer/dcs/http/a/a;)V
    ...
    invoke-virtual {v0, v1, p3}, Lcom/baidu/duer/dcs/http/b/c;->get(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
...
.method public getPing(Lcom/baidu/duer/dcs/framework/message/DcsRequestBody;Lcom/baidu/duer/dcs/http/a/a;)V
    ...
    .line 82
    iget-object p1, p0, Lcom/baidu/duer/dcs/http/b/i;->b:Lcom/baidu/duer/dcs/http/b/c;

    invoke-static {}, Lcom/baidu/duer/dcs/http/c;->getPingUrl()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0, p2}, Lcom/baidu/duer/dcs/http/b/c;->get(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
...
.method public postEvent(Lcom/baidu/duer/dcs/framework/message/DcsRequestBody;Lcom/baidu/duer/dcs/http/a/a;)V
    ...
    .line 91
    invoke-virtual {p0, p1, p2, v0}, Lcom/baidu/duer/dcs/http/b/i;->postEvent(Lcom/baidu/duer/dcs/framework/message/DcsRequestBody;Lcom/baidu/duer/dcs/http/a/a;Ljava/lang/String;)V
...
.method public postEvent(Lcom/baidu/duer/dcs/framework/message/DcsRequestBody;Lcom/baidu/duer/dcs/http/a/a;Ljava/lang/String;)V
    ...
    .line 102
    invoke-virtual {p0, p1, p2, p3}, Lcom/baidu/duer/dcs/http/b/i;->postEvent(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;Ljava/lang/String;)V
...
.method public postEvent(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;)V
    ...
    .line 107
    invoke-virtual {p0, p1, p2, v0}, Lcom/baidu/duer/dcs/http/b/i;->postEvent(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;Ljava/lang/String;)V
...
.method public postEvent(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2}, Lcom/baidu/duer/dcs/http/b/c;->post(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
    ...
    .line 121
    :cond_1
    new-instance v0, Lcom/baidu/turbonet/net/k;

    invoke-direct {v0}, Lcom/baidu/turbonet/net/k;-><init>()V
    ...
    .line 122
    invoke-virtual {v0, v1, v2}, Lcom/baidu/turbonet/net/k;->add(Ljava/lang/String;Ljava/lang/String;)Lcom/baidu/turbonet/net/k;
    ...
    .line 125
    new-instance v1, Lcom/baidu/turbonet/net/h;

    const-string v2, "dumi-boundory"

    invoke-direct {v1, v2}, Lcom/baidu/turbonet/net/h;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, p1}, Lcom/baidu/turbonet/net/h;->addPart(Lcom/baidu/turbonet/net/k;[B)Lcom/baidu/turbonet/net/h;

    move-result-object p1

    invoke-virtual {p1}, Lcom/baidu/turbonet/net/h;->finish()Lcom/baidu/turbonet/net/h;

    .line 127
    iget-object p1, p0, Lcom/baidu/duer/dcs/http/b/i;->c:Ljava/util/concurrent/Executor;

    invoke-virtual {p2, v1, p1}, Lcom/baidu/turbonet/net/UrlRequest$Builder;->setUploadDataProvider(Lcom/baidu/turbonet/net/y;Ljava/util/concurrent/Executor;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
...
.method public postMultipartEvent(Lcom/baidu/duer/dcs/framework/message/DcsRequestBody;Lcom/baidu/duer/dcs/http/i;Lcom/baidu/duer/dcs/http/a/a;)V
    ...
    .line 150
    :try_start_0
    new-instance v3, Lcom/baidu/turbonet/net/t;

    const/16 v1, 0x14

    const/16 v2, 0x1000

    invoke-direct {v3, v1, v2}, Lcom/baidu/turbonet/net/t;-><init>(II)V
    ...
    .line 152
    iget-object v1, p0, Lcom/baidu/duer/dcs/http/b/i;->b:Lcom/baidu/duer/dcs/http/b/c;

    invoke-static {}, Lcom/baidu/duer/dcs/http/c;->getEventsUrl()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2, p3, v3}, Lcom/baidu/duer/dcs/http/b/c;->post(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;Lcom/baidu/turbonet/net/t;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
    ...
    invoke-virtual {v1, p1}, Lcom/baidu/duer/dcs/util/k;->objectToJson(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcom/baidu/duer/dcs/http/b/i;->d:Ljava/lang/String;

    .line 162
    invoke-virtual {v3, p3}, Lcom/baidu/turbonet/net/t;->attachToRequest(Lcom/baidu/turbonet/net/UrlRequest$Builder;)V
    ...
    .line 169
    new-instance v4, Lcom/baidu/turbonet/net/k;

    invoke-direct {v4}, Lcom/baidu/turbonet/net/k;-><init>()V
    ...
    .line 170
    invoke-virtual {v4, p3, v0}, Lcom/baidu/turbonet/net/k;->add(Ljava/lang/String;Ljava/lang/String;)Lcom/baidu/turbonet/net/k;
    ...
    iget-object v1, p0, Lcom/baidu/duer/dcs/http/b/i;->d:Ljava/lang/String;
    ...
    .line 174
    new-instance v6, Lcom/baidu/turbonet/net/k;

    invoke-direct {v6}, Lcom/baidu/turbonet/net/k;-><init>()V
    ...
    .line 176
    invoke-virtual {v6, p3, v0}, Lcom/baidu/turbonet/net/k;->add(Ljava/lang/String;Ljava/lang/String;)Lcom/baidu/turbonet/net/k;
    ...
    .line 177
    invoke-virtual {p3, v0, v1}, Lcom/baidu/turbonet/net/k;->add(Ljava/lang/String;Ljava/lang/String;)Lcom/baidu/turbonet/net/k;

    .line 178
    iget-object p3, p0, Lcom/baidu/duer/dcs/http/b/i;->b:Lcom/baidu/duer/dcs/http/b/c;

    invoke-virtual {p3}, Lcom/baidu/duer/dcs/http/b/c;->getExecutor()Ljava/util/concurrent/Executor;

    move-result-object p3

    new-instance v0, Lcom/baidu/duer/dcs/http/b/i$1;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/baidu/duer/dcs/http/b/i$1;-><init>(Lcom/baidu/duer/dcs/http/b/i;Lcom/baidu/turbonet/net/t;Lcom/baidu/turbonet/net/k;Lcom/baidu/duer/dcs/http/i;Lcom/baidu/turbonet/net/k;Lcom/baidu/turbonet/net/UrlRequest;)V
...
.method public postString(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Lcom/baidu/duer/dcs/http/a/b;)V
    ...
    invoke-virtual {v0, p1, p4}, Lcom/baidu/duer/dcs/http/b/c;->post(Ljava/lang/String;Lcom/baidu/duer/dcs/http/a/a;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
    ...
    invoke-static {p2}, Lcom/baidu/turbonet/net/z;->create([B)Lcom/baidu/turbonet/net/y;
    ...
    invoke-virtual {p1, p2, p3}, Lcom/baidu/turbonet/net/UrlRequest$Builder;->setUploadDataProvider(Lcom/baidu/turbonet/net/y;Ljava/util/concurrent/Executor;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
...
.method public simpleRequest(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;[BLcom/baidu/duer/dcs/http/a/c;)V
    ...
    invoke-virtual {v0, p1, p2, p3, p5}, Lcom/baidu/duer/dcs/http/b/c;->getSimpleRequestBuilder(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/baidu/duer/dcs/http/a/c;)Lcom/baidu/turbonet/net/UrlRequest$Builder;
    ...
    .line 225
    invoke-static {p4}, Lcom/baidu/turbonet/net/z;->create([B)Lcom/baidu/turbonet/net/y;
