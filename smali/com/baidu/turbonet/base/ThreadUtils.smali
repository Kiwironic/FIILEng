.class public Lcom/baidu/turbonet/base/ThreadUtils;
...
.field private static sUiThreadHandler:Landroid/os/Handler; = null

.field private static sWillOverride:Z = false
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/baidu/turbonet/base/ThreadUtils;->sLock:Ljava/lang/Object;
...
.method private static getUiThreadHandler()Landroid/os/Handler;
    ...
    .line 48
    sget-object v0, Lcom/baidu/turbonet/base/ThreadUtils;->sLock:Ljava/lang/Object;

    monitor-enter v0

    .line 49
    :try_start_0
    sget-object v1, Lcom/baidu/turbonet/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;

    if-nez v1, :cond_1

    .line 50
    sget-boolean v1, Lcom/baidu/turbonet/base/ThreadUtils;->sWillOverride:Z
    ...
    sput-object v1, Lcom/baidu/turbonet/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;
...
.method public static getUiThreadLooper()Landroid/os/Looper;
    ...
    .line 203
    invoke-static {}, Lcom/baidu/turbonet/base/ThreadUtils;->getUiThreadHandler()Landroid/os/Handler;
...
.method public static runOnUiThread(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/FutureTask;
    ...
    invoke-static {v0}, Lcom/baidu/turbonet/base/ThreadUtils;->runOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
    ...
    .line 121
    invoke-static {}, Lcom/baidu/turbonet/base/ThreadUtils;->runningOnUiThread()Z
    ...
    .line 124
    :cond_0
    invoke-static {p0}, Lcom/baidu/turbonet/base/ThreadUtils;->postOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThreadBlocking(Ljava/lang/Runnable;)V
    ...
    .line 70
    invoke-static {v0}, Lcom/baidu/turbonet/base/ThreadUtils;->postOnUiThread(Ljava/util/concurrent/FutureTask;)Ljava/util/concurrent/FutureTask;
...
.method public static runOnUiThreadBlockingNoException(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    .line 89
    :try_start_0
    invoke-static {p0}, Lcom/baidu/turbonet/base/ThreadUtils;->runOnUiThreadBlocking(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
...
.method public static setUiThread(Landroid/os/Looper;)V
    ...
    sget-object v3, Lcom/baidu/turbonet/base/ThreadUtils;->sUiThreadHandler:Landroid/os/Handler;
...
.method public static setWillOverrideUiThread()V
    ...
    .line 30
    :try_start_0
    sput-boolean v1, Lcom/baidu/turbonet/base/ThreadUtils;->sWillOverride:Z
