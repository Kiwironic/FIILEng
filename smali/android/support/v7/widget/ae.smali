...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ae;->d:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ae;->e:Landroid/view/animation/DecelerateInterpolator;
    ...
    iput p1, p0, Landroid/support/v7/widget/ae;->n:F
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .line 128
    invoke-virtual {p0}, Landroid/support/v7/widget/ae;->e()V

    return-void

    .line 137
    :cond_0
    iget p3, p0, Landroid/support/v7/widget/ae;->g:I

    invoke-direct {p0, p3, p1}, Landroid/support/v7/widget/ae;->b(II)I

    move-result p1

    iput p1, p0, Landroid/support/v7/widget/ae;->g:I

    .line 138
    iget p1, p0, Landroid/support/v7/widget/ae;->h:I

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/ae;->b(II)I
    ...
    .line 140
    iget p1, p0, Landroid/support/v7/widget/ae;->g:I
    ...
    .line 141
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/widget/RecyclerView$q$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .line 233
    invoke-virtual {p0}, Landroid/support/v7/widget/ae;->getTargetPosition()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ae;->computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    .line 241
    iput-object v0, p0, Landroid/support/v7/widget/ae;->f:Landroid/graphics/PointF;
    ...
    iput v1, p0, Landroid/support/v7/widget/ae;->g:I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ae;->d:Landroid/view/animation/LinearInterpolator;

    invoke-virtual {p1, v1, v3, v0, v2}, Landroid/support/v7/widget/RecyclerView$q$a;->update(IIILandroid/view/animation/Interpolator;)V
    ...
    .line 236
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$q$a;->jumpTo(I)V
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/ae;->calculateDxToMakeVisible(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/ae;->calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    .line 115
    iget-object v1, p0, Landroid/support/v7/widget/ae;->e:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    iget v0, p0, Landroid/support/v7/widget/ae;->n:F
...
.method protected c()I
    ...
    .line 207
    iget-object v0, p0, Landroid/support/v7/widget/ae;->f:Landroid/graphics/PointF;
...
.method public calculateDxToMakeVisible(Landroid/view/View;I)I
    ...
    .line 328
    invoke-virtual {p0}, Landroid/support/v7/widget/ae;->getLayoutManager()Landroid/support/v7/widget/RecyclerView$g;
    ...
    .line 334
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$g;->getDecoratedLeft(Landroid/view/View;)I
    ...
    .line 335
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$g;->getDecoratedRight(Landroid/view/View;)I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$g;->getPaddingRight()I
    ...
    .line 338
    invoke-virtual/range {v4 .. v9}, Landroid/support/v7/widget/ae;->calculateDtToFit(IIIII)I
...
.method public calculateDyToMakeVisible(Landroid/view/View;I)I
    ...
    .line 309
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$g;->getDecoratedTop(Landroid/view/View;)I
    ...
    .line 310
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView$g;->getDecoratedBottom(Landroid/view/View;)I
