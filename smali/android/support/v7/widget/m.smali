...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/m;->c:Landroid/graphics/RectF;
    ...
    sput-object v0, Landroid/support/v7/widget/m;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    .line 78
    iput v0, p0, Landroid/support/v7/widget/m;->i:I
    ...
    .line 82
    iput v1, p0, Landroid/support/v7/widget/m;->k:F

    .line 84
    iput v1, p0, Landroid/support/v7/widget/m;->l:F

    .line 86
    iput v1, p0, Landroid/support/v7/widget/m;->m:F

    .line 89
    new-array v1, v0, [I

    iput-object v1, p0, Landroid/support/v7/widget/m;->n:[I

    .line 93
    iput-boolean v0, p0, Landroid/support/v7/widget/m;->o:Z

    .line 100
    iput-object p1, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;

    .line 101
    iget-object p1, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;

    invoke-virtual {p1}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/m;->r:Landroid/content/Context;
...
.method private a(Landroid/graphics/RectF;)I
    ...
    .line 642
    iget-object v0, p0, Landroid/support/v7/widget/m;->n:[I
    ...
    .line 653
    iget-object v3, p0, Landroid/support/v7/widget/m;->n:[I
    ...
    .line 662
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/m;->n:[I
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    .line 739
    iget-object v0, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;
    ...
    .line 740
    iget-object v1, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;
    ...
    .line 741
    iget-object v2, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/m;->p:Landroid/text/TextPaint;
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/m;->p:Landroid/text/TextPaint;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;
...
.method private a(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    .line 786
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/m;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 792
    sget-object v1, Landroid/support/v7/widget/m;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private a(FFF)V
    ...
    .line 503
    iput p1, p0, Landroid/support/v7/widget/m;->l:F

    .line 504
    iput p2, p0, Landroid/support/v7/widget/m;->m:F

    .line 505
    iput p3, p0, Landroid/support/v7/widget/m;->k:F

    const/4 p1, 0x0

    .line 506
    iput-boolean p1, p0, Landroid/support/v7/widget/m;->o:Z
...
.method private a(Landroid/content/res/TypedArray;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/m;->n:[I
...
.method private a(ILandroid/graphics/RectF;)Z
    ...
    iput-object v2, p0, Landroid/support/v7/widget/m;->p:Landroid/text/TextPaint;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;
...
.method private h()Z
    ...
    .line 435
    :goto_0
    iput-boolean v3, p0, Landroid/support/v7/widget/m;->o:Z

    .line 436
    iget-boolean v3, p0, Landroid/support/v7/widget/m;->o:Z

    if-eqz v3, :cond_1

    .line 437
    iput v2, p0, Landroid/support/v7/widget/m;->i:I
    ...
    .line 439
    iget-object v1, p0, Landroid/support/v7/widget/m;->n:[I
    ...
    iput v0, p0, Landroid/support/v7/widget/m;->m:F

    const/high16 v0, -0x40800000    # -1.0f

    .line 440
    iput v0, p0, Landroid/support/v7/widget/m;->k:F

    .line 442
    :cond_1
    iget-boolean v0, p0, Landroid/support/v7/widget/m;->o:Z
...
.method private i()Z
    ...
    .line 517
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/m;->l:F
    ...
    .line 518
    :goto_0
    iget v4, p0, Landroid/support/v7/widget/m;->k:F
    ...
    iget v5, p0, Landroid/support/v7/widget/m;->m:F
    ...
    .line 524
    iget v4, p0, Landroid/support/v7/widget/m;->l:F
    ...
    .line 527
    iget v5, p0, Landroid/support/v7/widget/m;->k:F
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->n:[I

    .line 532
    :cond_3
    iput-boolean v2, p0, Landroid/support/v7/widget/m;->j:Z
...
.method a(I)V
    ...
    .line 204
    :pswitch_0
    iget-object p1, p0, Landroid/support/v7/widget/m;->r:Landroid/content/Context;
...
.method a(IF)V
    ...
    .line 596
    iget-object v0, p0, Landroid/support/v7/widget/m;->r:Landroid/content/Context;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Landroid/support/v7/a/a$l;->AppCompatTextView:[I
    ...
    .line 111
    sget p2, Landroid/support/v7/a/a$l;->AppCompatTextView_autoSizeTextType:I
    ...
    iput p2, p0, Landroid/support/v7/widget/m;->i:I

    .line 115
    :cond_0
    sget p2, Landroid/support/v7/a/a$l;->AppCompatTextView_autoSizeStepGranularity:I
    ...
    .line 120
    :goto_0
    sget v1, Landroid/support/v7/a/a$l;->AppCompatTextView_autoSizeMinTextSize:I
    ...
    .line 125
    :goto_1
    sget v3, Landroid/support/v7/a/a$l;->AppCompatTextView_autoSizeMaxTextSize:I
    ...
    .line 130
    :goto_2
    sget v4, Landroid/support/v7/a/a$l;->AppCompatTextView_autoSizePresetSizes:I
    ...
    .line 147
    iget-boolean p1, p0, Landroid/support/v7/widget/m;->o:Z
...
.method a([II)V
    ...
    .line 316
    :cond_0
    iget-object v3, p0, Landroid/support/v7/widget/m;->r:Landroid/content/Context;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/m;->n:[I
    ...
    .line 331
    :cond_2
    iput-boolean v1, p0, Landroid/support/v7/widget/m;->o:Z
...
.method b()I
    ...
    .line 372
    iget v0, p0, Landroid/support/v7/widget/m;->k:F
...
.method d()I
    ...
    .line 404
    iget v0, p0, Landroid/support/v7/widget/m;->m:F
...
.method f()V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/m;->q:Landroid/widget/TextView;
    ...
    .line 569
    :cond_3
    sget-object v3, Landroid/support/v7/widget/m;->c:Landroid/graphics/RectF;

    monitor-enter v3

    .line 570
    :try_start_0
    sget-object v4, Landroid/support/v7/widget/m;->c:Landroid/graphics/RectF;
    ...
    .line 572
    sget-object v0, Landroid/support/v7/widget/m;->c:Landroid/graphics/RectF;
