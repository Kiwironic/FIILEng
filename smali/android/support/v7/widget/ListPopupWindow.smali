...
.field private final N:Landroid/support/v7/widget/ListPopupWindow$d;

.field private final O:Landroid/support/v7/widget/ListPopupWindow$c;

.field private final P:Landroid/support/v7/widget/ListPopupWindow$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Landroid/support/v7/widget/ListPopupWindow;->p:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v2, Landroid/support/v7/widget/ListPopupWindow;->q:Ljava/lang/reflect/Method;
    :try_end_1
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/ListPopupWindow$e;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->N:Landroid/support/v7/widget/ListPopupWindow$d;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->O:Landroid/support/v7/widget/ListPopupWindow$c;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->P:Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->R:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->g:Landroid/os/Handler;

    .line 259
    sget-object v2, Landroid/support/v7/a/a$l;->ListPopupWindow:[I
    ...
    .line 261
    sget v3, Landroid/support/v7/a/a$l;->ListPopupWindow_android_dropDownHorizontalOffset:I

    invoke-virtual {v2, v3, v1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v3

    iput v3, p0, Landroid/support/v7/widget/ListPopupWindow;->w:I

    .line 263
    sget v3, Landroid/support/v7/a/a$l;->ListPopupWindow_android_dropDownVerticalOffset:I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->h:Landroid/widget/PopupWindow;

    .line 271
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->h:Landroid/widget/PopupWindow;
...
.method private a(Landroid/view/View;IZ)I
    ...
    .line 1430
    :cond_0
    iget-object p3, p0, Landroid/support/v7/widget/ListPopupWindow;->h:Landroid/widget/PopupWindow;
...
.method private a()V
    ...
    .line 769
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->G:Landroid/view/View;
    ...
    .line 773
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->G:Landroid/view/View;
...
.method private b()I
    ...
    iput-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->Q:Ljava/lang/Runnable;

    .line 1158
    iget-boolean v5, p0, Landroid/support/v7/widget/ListPopupWindow;->T:Z

    xor-int/2addr v5, v3

    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/ListPopupWindow;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/y;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/support/v7/widget/y;

    .line 1159
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->K:Landroid/graphics/drawable/Drawable;

    if-eqz v5, :cond_0

    .line 1160
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/support/v7/widget/y;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->K:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->L:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->O:Landroid/support/v7/widget/ListPopupWindow$c;

    invoke-virtual {v5, v6}, Landroid/support/v7/widget/y;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V

    .line 1186
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->M:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->M:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    .line 1192
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->G:Landroid/view/View;
    ...
    .line 1203
    iget v8, p0, Landroid/support/v7/widget/ListPopupWindow;->H:I
    ...
    .line 1256
    :goto_3
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->h:Landroid/widget/PopupWindow;
    ...
    .line 1258
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->R:Landroid/graphics/Rect;

    invoke-virtual {v5, v6}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    .line 1259
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->R:Landroid/graphics/Rect;
    ...
    .line 1263
    iget-boolean v6, p0, Landroid/support/v7/widget/ListPopupWindow;->z:Z
    ...
    iput v6, p0, Landroid/support/v7/widget/ListPopupWindow;->x:I
    ...
    iget v6, p0, Landroid/support/v7/widget/ListPopupWindow;->x:I
    ...
    .line 1276
    iget-boolean v4, p0, Landroid/support/v7/widget/ListPopupWindow;->E:Z
    ...
    .line 1281
    :cond_9
    iget v2, p0, Landroid/support/v7/widget/ListPopupWindow;->v:I
    ...
    .line 1289
    :pswitch_2
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->s:Landroid/content/Context;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->R:Landroid/graphics/Rect;
    ...
    .line 1283
    :pswitch_3
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->s:Landroid/content/Context;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->R:Landroid/graphics/Rect;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/y;->measureHeightOfChildrenCompat(IIIII)I
...
.method public getAnchorView()Landroid/view/View;
    ...
    .line 454
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->J:Landroid/view/View;
...
.method public isModal()Z
    ...
    .line 339
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow;->T:Z
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 964
    invoke-static {p1}, Landroid/support/v7/widget/ListPopupWindow;->b(I)Z
    ...
    .line 968
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->h:Landroid/widget/PopupWindow;
    ...
    .line 970
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->t:Landroid/widget/ListAdapter;
    ...
    .line 979
    invoke-virtual {v6, v1, v3}, Landroid/support/v7/widget/y;->lookForSelectablePosition(IZ)I
    ...
    invoke-virtual {v5, v4, v1}, Landroid/support/v7/widget/y;->lookForSelectablePosition(IZ)I
    ...
    .line 995
    :cond_6
    iget-object v8, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/support/v7/widget/y;

    invoke-virtual {v8, v1}, Landroid/support/v7/widget/y;->setListSelectionHidden(Z)V

    .line 998
    iget-object v8, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/support/v7/widget/y;

    invoke-virtual {v8, p1, p2}, Landroid/support/v7/widget/y;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 1004
    iget-object p2, p0, Landroid/support/v7/widget/ListPopupWindow;->h:Landroid/widget/PopupWindow;
    ...
    .line 1009
    iget-object p2, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/support/v7/widget/y;

    invoke-virtual {p2}, Landroid/support/v7/widget/y;->requestFocusFromTouch()Z
...
.method public onKeyPreIme(ILandroid/view/KeyEvent;)Z
    ...
    .line 1078
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->J:Landroid/view/View;
...
.method public performItemClick(I)Z
    ...
    .line 860
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->L:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    .line 862
    invoke-virtual {v2}, Landroid/support/v7/widget/y;->getFirstVisiblePosition()I

    move-result v0

    sub-int v0, p1, v0

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/y;->getChildAt(I)Landroid/view/View;

    move-result-object v3

    .line 863
    invoke-virtual {v2}, Landroid/support/v7/widget/y;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    .line 864
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->L:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public postShow()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->Q:Ljava/lang/Runnable;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 281
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->I:Landroid/database/DataSetObserver;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->I:Landroid/database/DataSetObserver;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->I:Landroid/database/DataSetObserver;
    ...
    .line 291
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->d:Landroid/support/v7/widget/y;
...
.method public setAnchorView(Landroid/view/View;)V
    ...
    .line 464
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->J:Landroid/view/View;
...
.method public setContentWidth(I)V
    ...
    .line 551
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->R:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    .line 552
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->R:Landroid/graphics/Rect;
...
.method public setEpicenterBounds(Landroid/graphics/Rect;)V
    ...
    .line 512
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->S:Landroid/graphics/Rect;
...
.method public setForceIgnoreOutsideTouch(Z)V
    ...
    .line 351
    iput-boolean p1, p0, Landroid/support/v7/widget/ListPopupWindow;->F:Z
...
.method public setListSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 410
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->K:Landroid/graphics/drawable/Drawable;
...
.method public setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    .line 603
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->L:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    .line 614
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->M:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public setPromptView(Landroid/view/View;)V
    ...
    .line 628
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->G:Landroid/view/View;
...
.method public show()V
    ...
    iget v3, p0, Landroid/support/v7/widget/ListPopupWindow;->y:I
    ...
    .line 669
    :goto_0
    iget v7, p0, Landroid/support/v7/widget/ListPopupWindow;->u:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/ListPopupWindow;->F:Z
    ...
    .line 690
    iget-object v7, p0, Landroid/support/v7/widget/ListPopupWindow;->h:Landroid/widget/PopupWindow;

    invoke-virtual {p0}, Landroid/support/v7/widget/ListPopupWindow;->getAnchorView()Landroid/view/View;

    move-result-object v8

    iget v9, p0, Landroid/support/v7/widget/ListPopupWindow;->w:I

    iget v10, p0, Landroid/support/v7/widget/ListPopupWindow;->x:I
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/ListPopupWindow;->E:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->N:Landroid/support/v7/widget/ListPopupWindow$d;
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/ListPopupWindow;->B:Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->S:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->P:Landroid/support/v7/widget/ListPopupWindow$a;
