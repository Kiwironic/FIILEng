...
.field private final j:Landroid/support/v7/widget/d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    .line 198
    sget-object v0, Landroid/support/v7/a/a$l;->Spinner:[I
    ...
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/d;
    ...
    iput-object v3, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;

    goto :goto_1

    .line 206
    :cond_0
    sget p5, Landroid/support/v7/a/a$l;->Spinner_popupTheme:I

    invoke-virtual {v0, p5, v1}, Landroid/support/v7/widget/ay;->getResourceId(II)I
    ...
    :goto_0
    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;

    .line 216
    :goto_1
    iget-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->k:Landroid/content/Context;
    ...
    sget-object v4, Landroid/support/v7/a/a$l;->Spinner:[I

    invoke-static {p5, p2, v4, p3, v1}, Landroid/support/v7/widget/ay;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ay;

    move-result-object p5

    .line 238
    sget v1, Landroid/support/v7/a/a$l;->Spinner_android_dropDownWidth:I

    const/4 v4, -0x2

    invoke-virtual {p5, v1, v4}, Landroid/support/v7/widget/ay;->getLayoutDimension(II)I
    ...
    .line 240
    sget v1, Landroid/support/v7/a/a$l;->Spinner_android_popupBackground:I

    .line 241
    invoke-virtual {p5, v1}, Landroid/support/v7/widget/ay;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 242
    sget v1, Landroid/support/v7/a/a$l;->Spinner_android_prompt:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ay;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroid/support/v7/widget/AppCompatSpinner$b;->setPromptText(Ljava/lang/CharSequence;)V

    .line 243
    invoke-virtual {p5}, Landroid/support/v7/widget/ay;->recycle()V
    ...
    iput-object p5, p0, Landroid/support/v7/widget/AppCompatSpinner;->l:Landroid/support/v7/widget/ab;

    .line 263
    :cond_6
    sget p4, Landroid/support/v7/a/a$l;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroid/support/v7/widget/ay;->getTextArray(I)[Ljava/lang/CharSequence;
    ...
    .line 267
    sget p1, Landroid/support/v7/a/a$i;->support_simple_spinner_dropdown_item:I
    ...
    .line 277
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->m:Landroid/widget/SpinnerAdapter;
    ...
    .line 279
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->m:Landroid/widget/SpinnerAdapter;

    .line 282
    :cond_8
    iget-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/d;
...
.method protected drawableStateChanged()V
    ...
    .line 537
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->j:Landroid/support/v7/widget/d;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 413
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->l:Landroid/support/v7/widget/ab;
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/AppCompatSpinner$b;->setPromptText(Ljava/lang/CharSequence;)V
