...
.method private a(Landroid/support/v7/widget/RecyclerView$g;Landroid/support/v7/widget/ai;II)I
    .locals 2

    .line 167
    invoke-virtual {p0, p3, p4}, Landroid/support/v7/widget/af;->calculateScrollDistance(II)[I

    move-result-object p3

    .line 168
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/af;->b(Landroid/support/v7/widget/RecyclerView$g;Landroid/support/v7/widget/ai;)F
...
.method private b(Landroid/support/v7/widget/RecyclerView$g;Landroid/support/v7/widget/ai;)F
    .locals 10
    ...
    .line 243
    invoke-virtual {p1, v2}, Landroid/support/v7/widget/RecyclerView$g;->getChildAt(I)Landroid/view/View;

    move-result-object v7

    .line 244
    invoke-virtual {p1, v7}, Landroid/support/v7/widget/RecyclerView$g;->getPosition(Landroid/view/View;)I
    ...
    .line 260
    :cond_5
    invoke-virtual {p2, v3}, Landroid/support/v7/widget/ai;->getDecoratedStart(Landroid/view/View;)I
    ...
    .line 262
    invoke-virtual {p2, v3}, Landroid/support/v7/widget/ai;->getDecoratedEnd(Landroid/view/View;)I

    move-result v0

    .line 263
    invoke-virtual {p2, v5}, Landroid/support/v7/widget/ai;->getDecoratedEnd(Landroid/view/View;)I
...
.method private c(Landroid/support/v7/widget/RecyclerView$g;)Landroid/support/v7/widget/ai;
    ...
    .line 273
    iget-object v0, p0, Landroid/support/v7/widget/af;->d:Landroid/support/v7/widget/ai;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/af;->d:Landroid/support/v7/widget/ai;

    .line 276
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/af;->d:Landroid/support/v7/widget/ai;
...
.method private d(Landroid/support/v7/widget/RecyclerView$g;)Landroid/support/v7/widget/ai;
    ...
    .line 282
    iget-object v0, p0, Landroid/support/v7/widget/af;->e:Landroid/support/v7/widget/ai;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/af;->e:Landroid/support/v7/widget/ai;

    .line 285
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/af;->e:Landroid/support/v7/widget/ai;
...
.method public calculateDistanceToFinalSnap(Landroid/support/v7/widget/RecyclerView$g;Landroid/view/View;)[I
    ...
    .line 49
    invoke-direct {p0, p1}, Landroid/support/v7/widget/af;->d(Landroid/support/v7/widget/RecyclerView$g;)Landroid/support/v7/widget/ai;

    move-result-object v1

    .line 48
    invoke-direct {p0, p1, p2, v1}, Landroid/support/v7/widget/af;->a(Landroid/support/v7/widget/RecyclerView$g;Landroid/view/View;Landroid/support/v7/widget/ai;)I
    ...
    .line 56
    invoke-direct {p0, p1}, Landroid/support/v7/widget/af;->c(Landroid/support/v7/widget/RecyclerView$g;)Landroid/support/v7/widget/ai;
...
.method public findSnapView(Landroid/support/v7/widget/RecyclerView$g;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/af;->a(Landroid/support/v7/widget/RecyclerView$g;Landroid/support/v7/widget/ai;)Landroid/view/View;
...
.method public findTargetSnapPosition(Landroid/support/v7/widget/RecyclerView$g;II)I
    ...
    .line 75
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/af;->findSnapView(Landroid/support/v7/widget/RecyclerView$g;)Landroid/view/View;
    ...
    check-cast v3, Landroid/support/v7/widget/RecyclerView$q$b;

    add-int/lit8 v4, v0, -0x1

    .line 90
    invoke-interface {v3, v4}, Landroid/support/v7/widget/RecyclerView$q$b;->computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    .line 98
    invoke-direct {p0, p1, v5, p2, v7}, Landroid/support/v7/widget/af;->a(Landroid/support/v7/widget/RecyclerView$g;Landroid/support/v7/widget/ai;II)I
    ...
    .line 107
    invoke-direct {p0, p1, v5, v7, p3}, Landroid/support/v7/widget/af;->a(Landroid/support/v7/widget/RecyclerView$g;Landroid/support/v7/widget/ai;II)I
