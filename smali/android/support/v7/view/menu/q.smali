...
.field private final h:Landroid/support/v7/view/menu/e;
...
.field private p:Landroid/support/v7/view/menu/l$a;
...
.method static constructor <clinit>()V
    ...
    .line 46
    sget v0, Landroid/support/v7/a/a$i;->abc_popup_menu_item_layout:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/q;->m:Landroid/view/View$OnAttachStateChangeListener;
    ...
    .line 119
    iput-object p2, p0, Landroid/support/v7/view/menu/q;->g:Landroid/support/v7/view/menu/MenuBuilder;

    .line 120
    iput-boolean p6, p0, Landroid/support/v7/view/menu/q;->i:Z
    ...
    iget-boolean v1, p0, Landroid/support/v7/view/menu/q;->i:Z

    sget v2, Landroid/support/v7/view/menu/q;->e:I

    invoke-direct {v0, p2, p6, v1, v2}, Landroid/support/v7/view/menu/e;-><init>(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/LayoutInflater;ZI)V

    iput-object v0, p0, Landroid/support/v7/view/menu/q;->h:Landroid/support/v7/view/menu/e;

    .line 123
    iput p4, p0, Landroid/support/v7/view/menu/q;->k:I

    .line 124
    iput p5, p0, Landroid/support/v7/view/menu/q;->l:I
    ...
    sget p6, Landroid/support/v7/a/a$e;->abc_config_prefDialogWidth:I
    ...
    iput p4, p0, Landroid/support/v7/view/menu/q;->j:I

    .line 130
    iput-object p3, p0, Landroid/support/v7/view/menu/q;->o:Landroid/view/View;
    ...
    iget p5, p0, Landroid/support/v7/view/menu/q;->k:I

    iget p6, p0, Landroid/support/v7/view/menu/q;->l:I
    ...
    iput-object p3, p0, Landroid/support/v7/view/menu/q;->a:Landroid/support/v7/widget/MenuPopupWindow;

    .line 135
    invoke-virtual {p2, p0, p1}, Landroid/support/v7/view/menu/MenuBuilder;->addMenuPresenter(Landroid/support/v7/view/menu/l;Landroid/content/Context;)V
...
.method private b()Z
    ...
    .line 149
    invoke-virtual {p0}, Landroid/support/v7/view/menu/q;->isShowing()Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/q;->o:Landroid/view/View;
    ...
    .line 159
    iget-object v0, p0, Landroid/support/v7/view/menu/q;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    .line 169
    :cond_3
    iget-object v3, p0, Landroid/support/v7/view/menu/q;->m:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v0, v3}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    .line 170
    iget-object v3, p0, Landroid/support/v7/view/menu/q;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    iget v3, p0, Landroid/support/v7/view/menu/q;->t:I
    ...
    .line 174
    iget-object v0, p0, Landroid/support/v7/view/menu/q;->h:Landroid/support/v7/view/menu/e;

    iget-object v4, p0, Landroid/support/v7/view/menu/q;->f:Landroid/content/Context;

    iget v5, p0, Landroid/support/v7/view/menu/q;->j:I
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/q;->getEpicenterBounds()Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/q;->g:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    sget v5, Landroid/support/v7/a/a$i;->abc_popup_menu_header_item_layout:I
    ...
    .line 192
    iget-object v6, p0, Landroid/support/v7/view/menu/q;->g:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/q;->h:Landroid/support/v7/view/menu/e;
...
.method public onCloseMenu(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 301
    iget-object v0, p0, Landroid/support/v7/view/menu/q;->g:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 303
    :cond_0
    invoke-virtual {p0}, Landroid/support/v7/view/menu/q;->dismiss()V

    .line 304
    iget-object v0, p0, Landroid/support/v7/view/menu/q;->p:Landroid/support/v7/view/menu/l$a;
...
.method public onDismiss()V
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/q;->m:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v0, v1}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    .line 242
    iget-object v0, p0, Landroid/support/v7/view/menu/q;->n:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public onSubMenuSelected(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    iget-boolean v6, p0, Landroid/support/v7/view/menu/q;->i:Z

    iget v7, p0, Landroid/support/v7/view/menu/q;->k:I

    iget v8, p0, Landroid/support/v7/view/menu/q;->l:I
    ...
    .line 266
    iget-object v2, p0, Landroid/support/v7/view/menu/q;->p:Landroid/support/v7/view/menu/l$a;

    invoke-virtual {v0, v2}, Landroid/support/v7/view/menu/k;->setPresenterCallback(Landroid/support/v7/view/menu/l$a;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/view/menu/k;->setForceShowIcon(Z)V

    .line 270
    iget-object v2, p0, Landroid/support/v7/view/menu/q;->n:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v2}, Landroid/support/v7/view/menu/k;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    const/4 v2, 0x0

    .line 271
    iput-object v2, p0, Landroid/support/v7/view/menu/q;->n:Landroid/widget/PopupWindow$OnDismissListener;

    .line 274
    iget-object v2, p0, Landroid/support/v7/view/menu/q;->g:Landroid/support/v7/view/menu/MenuBuilder;

    invoke-virtual {v2, v1}, Landroid/support/v7/view/menu/MenuBuilder;->close(Z)V

    .line 277
    iget-object v2, p0, Landroid/support/v7/view/menu/q;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/q;->o:Landroid/view/View;
    ...
    .line 285
    iget-object v4, p0, Landroid/support/v7/view/menu/q;->o:Landroid/view/View;
    ...
    .line 288
    :cond_0
    invoke-virtual {v0, v2, v3}, Landroid/support/v7/view/menu/k;->tryShow(II)Z
...
.method public setAnchorView(Landroid/view/View;)V
    ...
    .line 325
    iput-object p1, p0, Landroid/support/v7/view/menu/q;->o:Landroid/view/View;
...
.method public setCallback(Landroid/support/v7/view/menu/l$a;)V
    ...
    .line 258
    iput-object p1, p0, Landroid/support/v7/view/menu/q;->p:Landroid/support/v7/view/menu/l$a;
...
.method public setForceShowIcon(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/e;->setForceShowIcon(Z)V
...
.method public setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .line 339
    iput-object p1, p0, Landroid/support/v7/view/menu/q;->n:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public show()V
    ...
    .line 208
    invoke-direct {p0}, Landroid/support/v7/view/menu/q;->b()Z
...
.method public updateMenuView(Z)V
    ...
    .line 251
    iget-object p1, p0, Landroid/support/v7/view/menu/q;->h:Landroid/support/v7/view/menu/e;
    ...
    invoke-virtual {p1}, Landroid/support/v7/view/menu/e;->notifyDataSetChanged()V
