.class public Landroid/support/transition/r;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/r;->a:[Ljava/lang/Class;
    ...
    sput-object v0, Landroid/support/transition/r;->b:Landroid/support/v4/util/ArrayMap;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 50
    iput-object p1, p0, Landroid/support/transition/r;->c:Landroid/content/Context;
...
.method private a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
    ...
    iget-object v4, p0, Landroid/support/transition/r;->c:Landroid/content/Context;
    ...
    invoke-direct {p0, p2, v3, v4}, Landroid/support/transition/r;->a(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 156
    invoke-direct {p0, p1, p2, p3}, Landroid/support/transition/r;->b(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)V
    ...
    iget-object v5, p0, Landroid/support/transition/r;->c:Landroid/content/Context;
    ...
    invoke-direct {p0, p2, v4, v5}, Landroid/support/transition/r;->a(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 178
    invoke-direct {p0, p1, p2, v3}, Landroid/support/transition/r;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
...
.method private a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/support/transition/t;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/xmlpull/v1/XmlPullParserException;,
    ...
    .line 297
    new-instance v1, Landroid/support/transition/t;

    invoke-direct {v1}, Landroid/support/transition/t;-><init>()V
    ...
    .line 299
    invoke-direct {p0, p2, p1, p3, v1}, Landroid/support/transition/r;->a(Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/ViewGroup;Landroid/support/transition/t;)V
...
.method private a(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    sget-object p3, Landroid/support/transition/r;->b:Landroid/support/v4/util/ArrayMap;
    ...
    .line 201
    :try_start_1
    sget-object v1, Landroid/support/transition/r;->b:Landroid/support/v4/util/ArrayMap;
    ...
    .line 204
    iget-object v3, p0, Landroid/support/transition/r;->c:Landroid/content/Context;
    ...
    .line 207
    sget-object v1, Landroid/support/transition/r;->a:[Ljava/lang/Class;
    ...
    .line 209
    sget-object v3, Landroid/support/transition/r;->b:Landroid/support/v4/util/ArrayMap;
...
.method private a(Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/ViewGroup;Landroid/support/transition/t;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 310
    iget-object v0, p0, Landroid/support/transition/r;->c:Landroid/content/Context;

    sget-object v1, Landroid/support/transition/q;->b:[I
    ...
    invoke-static {p3, v2, v4}, Landroid/support/transition/o;->getSceneForLayout(Landroid/view/ViewGroup;ILandroid/content/Context;)Landroid/support/transition/o;
    ...
    .line 319
    :cond_1
    iget-object v1, p0, Landroid/support/transition/r;->c:Landroid/content/Context;

    invoke-static {p3, p2, v1}, Landroid/support/transition/o;->getSceneForLayout(Landroid/view/ViewGroup;ILandroid/content/Context;)Landroid/support/transition/o;
    ...
    .line 322
    invoke-virtual {p0, v0}, Landroid/support/transition/r;->inflateTransition(I)Landroid/support/transition/Transition;
    ...
    .line 328
    invoke-virtual {p4, v3, p2}, Landroid/support/transition/t;->setTransition(Landroid/support/transition/o;Landroid/support/transition/Transition;)V

    goto :goto_2

    .line 330
    :cond_3
    invoke-virtual {p4, v2, v3, p2}, Landroid/support/transition/t;->setTransition(Landroid/support/transition/o;Landroid/support/transition/o;Landroid/support/transition/Transition;)V
...
.method private b(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)V
    ...
    sget-object v5, Landroid/support/transition/q;->a:[I
...
.method public static from(Landroid/content/Context;)Landroid/support/transition/r;
    .locals 1

    .line 57
    new-instance v0, Landroid/support/transition/r;

    invoke-direct {v0, p0}, Landroid/support/transition/r;-><init>(Landroid/content/Context;)V
...
.method public inflateTransition(I)Landroid/support/transition/Transition;
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/transition/r;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
...
.method public inflateTransitionManager(ILandroid/view/ViewGroup;)Landroid/support/transition/t;
    .locals 3
    ...
    invoke-direct {p0, p1, v0, p2}, Landroid/support/transition/r;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/support/transition/t;
