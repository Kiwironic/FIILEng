...
# static fields
.field private static B:Landroid/support/transition/n; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->r:[Ljava/lang/String;
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->s:Landroid/util/Property;
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->t:Landroid/util/Property;
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->u:Landroid/util/Property;
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->v:Landroid/util/Property;
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->w:Landroid/util/Property;
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->x:Landroid/util/Property;
    ...
    sput-object v0, Landroid/support/transition/ChangeBounds;->B:Landroid/support/transition/n;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/transition/ChangeBounds;->y:[I

    const/4 v0, 0x0

    .line 164
    iput-boolean v0, p0, Landroid/support/transition/ChangeBounds;->z:Z

    .line 165
    iput-boolean v0, p0, Landroid/support/transition/ChangeBounds;->A:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 175
    sget-object v1, Landroid/support/transition/q;->d:[I
...
.method private a(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 246
    iget-boolean v0, p0, Landroid/support/transition/ChangeBounds;->A:Z
    ...
    .line 247
    invoke-virtual {p0, p1, v1}, Landroid/support/transition/ChangeBounds;->a(Landroid/view/View;Z)Landroid/support/transition/w;
    ...
    .line 251
    :cond_1
    iget-object p1, v0, Landroid/support/transition/w;->b:Landroid/view/View;
...
.method private b(Landroid/support/transition/w;)V
    ...
    iget-object v3, p1, Landroid/support/transition/w;->b:Landroid/view/View;
    ...
    .line 223
    iget-boolean v1, p0, Landroid/support/transition/ChangeBounds;->A:Z
    ...
    iget-object v2, p0, Landroid/support/transition/ChangeBounds;->y:[I
    ...
    iget-object v3, p0, Landroid/support/transition/ChangeBounds;->y:[I
    ...
    .line 228
    :cond_1
    iget-boolean v1, p0, Landroid/support/transition/ChangeBounds;->z:Z
...
.method public captureEndValues(Landroid/support/transition/w;)V
    ...
    .line 241
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeBounds;->b(Landroid/support/transition/w;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/w;Landroid/support/transition/w;)Landroid/animation/Animator;
    ...
    .line 264
    :cond_0
    iget-object v3, v0, Landroid/support/transition/w;->a:Ljava/util/Map;

    .line 265
    iget-object v4, v1, Landroid/support/transition/w;->a:Ljava/util/Map;
    ...
    .line 271
    :cond_1
    iget-object v9, v1, Landroid/support/transition/w;->b:Landroid/view/View;
    ...
    .line 274
    iget-object v5, v1, Landroid/support/transition/w;->a:Ljava/util/Map;
    ...
    .line 287
    iget-object v0, v0, Landroid/support/transition/w;->a:Ljava/util/Map;
    ...
    .line 288
    iget-object v1, v1, Landroid/support/transition/w;->a:Ljava/util/Map;
    ...
    .line 300
    iget-boolean v9, v8, Landroid/support/transition/ChangeBounds;->z:Z
    ...
    .line 301
    invoke-static {v9, v6, v11, v13, v3}, Landroid/support/transition/ai;->a(Landroid/view/View;IIII)V
    ...
    .line 307
    sget-object v1, Landroid/support/transition/ChangeBounds;->x:Landroid/util/Property;
    ...
    .line 313
    sget-object v4, Landroid/support/transition/ChangeBounds;->t:Landroid/util/Property;
    ...
    .line 318
    sget-object v4, Landroid/support/transition/ChangeBounds;->u:Landroid/util/Property;
    ...
    .line 338
    sget-object v1, Landroid/support/transition/ChangeBounds;->v:Landroid/util/Property;
    ...
    .line 333
    sget-object v1, Landroid/support/transition/ChangeBounds;->w:Landroid/util/Property;
    ...
    .line 345
    invoke-static {v9, v6, v11, v1, v3}, Landroid/support/transition/ai;->a(Landroid/view/View;IIII)V
    ...
    .line 352
    sget-object v3, Landroid/support/transition/ChangeBounds;->x:Landroid/util/Property;
    ...
    .line 365
    sget-object v5, Landroid/support/transition/ChangeBounds;->B:Landroid/support/transition/n;
    ...
    .line 385
    :goto_8
    invoke-static {v11, v10}, Landroid/support/transition/v;->a(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 390
    invoke-static {v1, v2}, Landroid/support/transition/ac;->a(Landroid/view/ViewGroup;Z)V
    ...
    .line 418
    invoke-virtual {v8, v2}, Landroid/support/transition/ChangeBounds;->addListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/Transition;
    ...
    .line 423
    :cond_17
    iget-object v2, v0, Landroid/support/transition/w;->a:Ljava/util/Map;
    ...
    .line 425
    iget-object v3, v1, Landroid/support/transition/w;->a:Ljava/util/Map;
    ...
    :cond_19
    :goto_a
    iget-object v4, v8, Landroid/support/transition/ChangeBounds;->y:[I
    ...
    .line 436
    invoke-static {v9}, Landroid/support/transition/ai;->c(Landroid/view/View;)F
    ...
    .line 437
    invoke-static {v9, v4}, Landroid/support/transition/ai;->a(Landroid/view/View;F)V

    .line 438
    invoke-static/range {p1 .. p1}, Landroid/support/transition/ai;->a(Landroid/view/View;)Landroid/support/transition/ah;

    move-result-object v4

    invoke-interface {v4, v6}, Landroid/support/transition/ah;->add(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v10, v8, Landroid/support/transition/ChangeBounds;->y:[I
    ...
    .line 442
    sget-object v1, Landroid/support/transition/ChangeBounds;->s:Landroid/util/Property;
...
.method public getResizeClip()Z
    ...
    .line 213
    iget-boolean v0, p0, Landroid/support/transition/ChangeBounds;->z:Z
...
.method public getTransitionProperties()[Ljava/lang/String;
    ...
    .line 185
    sget-object v0, Landroid/support/transition/ChangeBounds;->r:[Ljava/lang/String;
...
.method public setResizeClip(Z)V
    ...
    .line 202
    iput-boolean p1, p0, Landroid/support/transition/ChangeBounds;->z:Z
