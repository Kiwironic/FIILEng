...
.method static a(Landroid/view/View;Landroid/support/transition/w;IIFFFFLandroid/animation/TimeInterpolator;)Landroid/animation/Animator;
    .locals 16
    ...
    .line 53
    iget-object v8, v0, Landroid/support/transition/w;->b:Landroid/view/View;

    sget v9, Landroid/support/transition/m$e;->transition_position:I
    ...
    .line 71
    new-instance v9, Landroid/support/transition/y$a;

    iget-object v2, v0, Landroid/support/transition/w;->b:Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/transition/y$a;-><init>(Landroid/view/View;Landroid/view/View;IIFF)V

    .line 73
    invoke-virtual {v8, v9}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 74
    invoke-static {v8, v9}, Landroid/support/transition/a;->a(Landroid/animation/Animator;Landroid/animation/AnimatorListenerAdapter;)V
