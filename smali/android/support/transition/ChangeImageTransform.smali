...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/ChangeImageTransform;->o:[Ljava/lang/String;
    ...
    sput-object v0, Landroid/support/transition/ChangeImageTransform;->p:Landroid/animation/TypeEvaluator;
    ...
    sput-object v0, Landroid/support/transition/ChangeImageTransform;->q:Landroid/util/Property;
...
.method private a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    .line 177
    sget-object v0, Landroid/support/transition/ChangeImageTransform;->q:Landroid/util/Property;

    sget-object v1, Landroid/support/transition/ChangeImageTransform;->p:Landroid/animation/TypeEvaluator;
...
.method private a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    new-instance v1, Landroid/support/transition/v$a;

    invoke-direct {v1}, Landroid/support/transition/v$a;-><init>()V
...
.method public captureEndValues(Landroid/support/transition/w;)V
    ...
    .line 110
    invoke-direct {p0, p1}, Landroid/support/transition/ChangeImageTransform;->b(Landroid/support/transition/w;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/w;Landroid/support/transition/w;)Landroid/animation/Animator;
    ...
    .line 141
    iget-object v2, p3, Landroid/support/transition/w;->a:Ljava/util/Map;
    ...
    .line 150
    :cond_5
    iget-object p1, p3, Landroid/support/transition/w;->b:Landroid/view/View;
    ...
    .line 155
    invoke-static {p1}, Landroid/support/transition/h;->a(Landroid/widget/ImageView;)V
    ...
    .line 167
    :cond_8
    sget-object p3, Landroid/support/transition/ChangeImageTransform;->q:Landroid/util/Property;
    ...
    .line 171
    :goto_2
    invoke-static {p1, p2}, Landroid/support/transition/h;->a(Landroid/widget/ImageView;Landroid/animation/Animator;)V
...
.method public getTransitionProperties()[Ljava/lang/String;
    ...
    .line 115
    sget-object v0, Landroid/support/transition/ChangeImageTransform;->o:[Ljava/lang/String;
