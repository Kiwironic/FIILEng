...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;

    const/4 v0, 0x1

    .line 80
    iput-boolean v0, p0, Landroid/support/transition/TransitionSet;->v:Z
    ...
    .line 87
    iput v0, p0, Landroid/support/transition/TransitionSet;->w:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 114
    sget-object v1, Landroid/support/transition/q;->i:[I
...
.method private e()V
    ...
    .line 409
    iget-object v1, p0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;
    ...
    .line 410
    invoke-virtual {v2, v0}, Landroid/support/transition/Transition;->addListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/Transition;

    goto :goto_0

    .line 412
    :cond_0
    iget-object v0, p0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;
...
.method a(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 631
    :goto_0
    iget-object v2, p0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;
...
.method protected a()V
    ...
    .line 482
    invoke-virtual {p0}, Landroid/support/transition/TransitionSet;->b()V
    ...
    .line 486
    :cond_0
    invoke-direct {p0}, Landroid/support/transition/TransitionSet;->e()V

    .line 487
    iget-boolean v0, p0, Landroid/support/transition/TransitionSet;->v:Z
    ...
    invoke-virtual {v1, v3}, Landroid/support/transition/Transition;->addListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/Transition;
    ...
    .line 507
    invoke-virtual {v1}, Landroid/support/transition/Transition;->a()V
...
.method a(Landroid/support/transition/w;)V
    ...
    .line 538
    invoke-super {p0, p1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/w;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/transition/Transition;->a(Landroid/support/transition/w;)V
...
.method protected a(Landroid/view/ViewGroup;Landroid/support/transition/x;Landroid/support/transition/x;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 457
    iget-object v3, v0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;
    ...
    .line 459
    iget-object v5, v0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;
    ...
    .line 462
    iget-boolean v5, v0, Landroid/support/transition/TransitionSet;->v:Z
...
.method public bridge synthetic addListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/Transition;
    ...
    .line 61
    invoke-virtual {p0, p1}, Landroid/support/transition/TransitionSet;->addListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/TransitionSet;
...
.method public addListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/TransitionSet;
    .locals 0
    .param p1    # Landroid/support/transition/Transition$d;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public addTransition(Landroid/support/transition/Transition;)Landroid/support/transition/TransitionSet;
    ...
    .line 181
    :cond_0
    iget v0, p0, Landroid/support/transition/TransitionSet;->w:I
    ...
    .line 185
    invoke-virtual {p0}, Landroid/support/transition/TransitionSet;->getPropagation()Landroid/support/transition/u;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/support/transition/Transition;->setPropagation(Landroid/support/transition/u;)V
    ...
    .line 191
    invoke-virtual {p0}, Landroid/support/transition/TransitionSet;->getEpicenterCallback()Landroid/support/transition/Transition$c;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/support/transition/Transition;->setEpicenterCallback(Landroid/support/transition/Transition$c;)V
...
.method public captureEndValues(Landroid/support/transition/w;)V
    ...
    .line 529
    invoke-virtual {v1, p1}, Landroid/support/transition/Transition;->captureEndValues(Landroid/support/transition/w;)V
...
.method public captureStartValues(Landroid/support/transition/w;)V
    ...
    .line 517
    invoke-virtual {v1, p1}, Landroid/support/transition/Transition;->captureStartValues(Landroid/support/transition/w;)V
...
.method public clone()Landroid/support/transition/Transition;
    ...
    iput-object v1, v0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;
    ...
    .line 643
    iget-object v3, p0, Landroid/support/transition/TransitionSet;->u:Ljava/util/ArrayList;
...
.method protected d()V
    ...
    .line 571
    invoke-super {p0}, Landroid/support/transition/Transition;->d()V
    ...
    invoke-virtual {v2}, Landroid/support/transition/Transition;->d()V
...
.method public bridge synthetic removeListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/Transition;
    ...
    .line 61
    invoke-virtual {p0, p1}, Landroid/support/transition/TransitionSet;->removeListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/TransitionSet;
...
.method public removeListener(Landroid/support/transition/Transition$d;)Landroid/support/transition/TransitionSet;
    .locals 0
    .param p1    # Landroid/support/transition/Transition$d;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public setOrdering(I)Landroid/support/transition/TransitionSet;
    ...
    .line 134
    iput-boolean p1, p0, Landroid/support/transition/TransitionSet;->v:Z
...
.method public setPropagation(Landroid/support/transition/u;)V
    ...
    .line 610
    invoke-super {p0, p1}, Landroid/support/transition/Transition;->setPropagation(Landroid/support/transition/u;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/transition/Transition;->setPropagation(Landroid/support/transition/u;)V
