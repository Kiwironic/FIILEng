...
# static fields
.field static final a:Ljava/lang/String; = ".dex"

.field static final b:Ljava/lang/String; = ".zip"

.field private static final c:Ljava/lang/String; = "MultiDex"

.field private static final d:Ljava/lang/String; = "classes"

.field private static final e:Ljava/lang/String; = ".classes"
...
.field private final u:Ljava/nio/channels/FileLock;
...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 96
    iput-object p1, p0, Landroid/support/multidex/MultiDexExtractor;->p:Ljava/io/File;

    .line 97
    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->r:Ljava/io/File;
    ...
    iput-wide v0, p0, Landroid/support/multidex/MultiDexExtractor;->q:J
    ...
    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->s:Ljava/io/RandomAccessFile;

    .line 102
    :try_start_0
    iget-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->s:Ljava/io/RandomAccessFile;

    invoke-virtual {p2}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p2

    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->t:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    .line 105
    iget-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->t:Ljava/nio/channels/FileChannel;

    invoke-virtual {p2}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;

    move-result-object p2

    iput-object p2, p0, Landroid/support/multidex/MultiDexExtractor;->u:Ljava/nio/channels/FileLock;
    :try_end_1
...
.method private a()Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/support/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    iget-object v3, p0, Landroid/support/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    iget-object v7, p0, Landroid/support/multidex/MultiDexExtractor;->r:Ljava/io/File;
...
.method private a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Landroid/support/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    iget-object v9, v0, Landroid/support/multidex/MultiDexExtractor;->r:Ljava/io/File;
...
.method private b()V
    ...
    .line 354
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->r:Ljava/io/File;
    ...
    iget-object v2, p0, Landroid/support/multidex/MultiDexExtractor;->r:Ljava/io/File;
...
.method a(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v2, p0, Landroid/support/multidex/MultiDexExtractor;->p:Ljava/io/File;
    ...
    .line 131
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->u:Ljava/nio/channels/FileLock;
    ...
    .line 136
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->p:Ljava/io/File;

    iget-wide v1, p0, Landroid/support/multidex/MultiDexExtractor;->q:J
    ...
    iget-wide v6, p0, Landroid/support/multidex/MultiDexExtractor;->q:J
    ...
    iget-wide v5, p0, Landroid/support/multidex/MultiDexExtractor;->q:J
...
.method public close()V
    ...
    .line 164
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->t:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    .line 165
    iget-object v0, p0, Landroid/support/multidex/MultiDexExtractor;->s:Ljava/io/RandomAccessFile;
