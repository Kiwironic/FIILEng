...
.method public canReuseCache()Z
    ...
    .line 1092
    iget-boolean v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->l:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->h:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->c:Landroid/content/res/ColorStateList;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->j:I
...
.method public createCachedBitmapIfNeeded(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->canReuseBitmap(II)Z
    ...
    .line 1078
    iput-boolean p1, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->l:Z
...
.method public drawCachedBitmapWithRootAlpha(Landroid/graphics/Canvas;Landroid/graphics/ColorFilter;Landroid/graphics/Rect;)V
    ...
    .line 1043
    invoke-virtual {p0, p2}, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->getPaint(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
...
.method public getPaint(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
    ...
    .line 1055
    invoke-virtual {p0}, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->hasTranslucentRoot()Z
    ...
    .line 1059
    :cond_0
    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->m:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->m:Landroid/graphics/Paint;
    ...
    .line 1065
    iget-object p1, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->m:Landroid/graphics/Paint;
...
.method public isStateful()Z
    ...
    invoke-virtual {v0}, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->isStateful()Z
...
.method public onStateChanged([I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->onStateChanged([I)Z
    ...
    iput-boolean v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->l:Z
...
.method public updateCacheStates()V
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->h:Landroid/content/res/ColorStateList;

    .line 1106
    iget-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroid/support/graphics/drawable/VectorDrawableCompat$g;->j:I
...
.method public updateCachedBitmap(II)V
    ...
    invoke-virtual {v1, v0, p1, p2, v2}, Landroid/support/graphics/drawable/VectorDrawableCompat$f;->draw(Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
