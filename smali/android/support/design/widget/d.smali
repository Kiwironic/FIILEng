...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->K:Landroid/text/TextPaint;
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->L:Landroid/text/TextPaint;
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->h:Landroid/graphics/Rect;
    ...
    iput-object p1, p0, Landroid/support/design/widget/d;->i:Landroid/graphics/RectF;
...
.method private a(F)V
    ...
    .line 403
    invoke-direct {p0, p1}, Landroid/support/design/widget/d;->b(F)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/d;->M:Landroid/animation/TimeInterpolator;
    ...
    iget-object v2, p0, Landroid/support/design/widget/d;->N:Landroid/animation/TimeInterpolator;
    ...
    .line 414
    invoke-direct {p0}, Landroid/support/design/widget/d;->c()I

    move-result v1

    invoke-virtual {p0}, Landroid/support/design/widget/d;->getCurrentCollapsedTextColor()I
    ...
    iget v2, p0, Landroid/support/design/widget/d;->O:F
    ...
    iget v2, p0, Landroid/support/design/widget/d;->T:F
    ...
    iget v4, p0, Landroid/support/design/widget/d;->U:F

    iget v5, p0, Landroid/support/design/widget/d;->Q:F
    ...
    iget v4, p0, Landroid/support/design/widget/d;->V:I

    iget v5, p0, Landroid/support/design/widget/d;->R:I
    ...
    .line 425
    iget-object p1, p0, Landroid/support/design/widget/d;->d:Landroid/view/View;
...
.method private b(F)V
    ...
    iget-object v3, p0, Landroid/support/design/widget/d;->M:Landroid/animation/TimeInterpolator;
...
.method private c(F)V
    ...
    :goto_0
    iput-boolean p1, p0, Landroid/support/design/widget/d;->B:Z

    .line 593
    iget-boolean p1, p0, Landroid/support/design/widget/d;->B:Z
...
.method private d()V
    ...
    iget-object v4, p0, Landroid/support/design/widget/d;->z:Ljava/lang/CharSequence;

    iget-object v5, p0, Landroid/support/design/widget/d;->z:Ljava/lang/CharSequence;
    ...
    iget-boolean v5, p0, Landroid/support/design/widget/d;->A:Z
    ...
    .line 467
    iget-object v5, p0, Landroid/support/design/widget/d;->K:Landroid/text/TextPaint;

    invoke-virtual {v5}, Landroid/text/TextPaint;->descent()F

    move-result v5

    iget-object v9, p0, Landroid/support/design/widget/d;->K:Landroid/text/TextPaint;
    ...
    .line 469
    iget-object v9, p0, Landroid/support/design/widget/d;->h:Landroid/graphics/Rect;
    ...
    iput v9, p0, Landroid/support/design/widget/d;->q:F

    goto :goto_1

    .line 460
    :cond_1
    iget-object v5, p0, Landroid/support/design/widget/d;->h:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->bottom:I

    int-to-float v5, v5

    iput v5, p0, Landroid/support/design/widget/d;->q:F
    ...
    .line 481
    iget-object v1, p0, Landroid/support/design/widget/d;->h:Landroid/graphics/Rect;
    ...
    .line 477
    :cond_3
    iget-object v4, p0, Landroid/support/design/widget/d;->h:Landroid/graphics/Rect;
    ...
    iput v4, p0, Landroid/support/design/widget/d;->s:F
    ...
    iget-boolean v3, p0, Landroid/support/design/widget/d;->A:Z
    ...
    iget-object v4, p0, Landroid/support/design/widget/d;->K:Landroid/text/TextPaint;
    ...
    iput v4, p0, Landroid/support/design/widget/d;->p:F
    ...
    iput v3, p0, Landroid/support/design/widget/d;->p:F
    ...
    .line 519
    :goto_4
    invoke-direct {p0}, Landroid/support/design/widget/d;->f()V
...
.method private d(F)V
    ...
    .line 615
    iget p1, p0, Landroid/support/design/widget/d;->m:F

    .line 616
    iput v3, p0, Landroid/support/design/widget/d;->G:F

    .line 617
    iget-object v1, p0, Landroid/support/design/widget/d;->x:Landroid/graphics/Typeface;

    iget-object v2, p0, Landroid/support/design/widget/d;->v:Landroid/graphics/Typeface;

    if-eq v1, v2, :cond_1

    .line 618
    iget-object v1, p0, Landroid/support/design/widget/d;->v:Landroid/graphics/Typeface;

    iput-object v1, p0, Landroid/support/design/widget/d;->x:Landroid/graphics/Typeface;
    ...
    .line 624
    iget-object v6, p0, Landroid/support/design/widget/d;->x:Landroid/graphics/Typeface;

    iget-object v7, p0, Landroid/support/design/widget/d;->w:Landroid/graphics/Typeface;
    ...
    iput-object v6, p0, Landroid/support/design/widget/d;->x:Landroid/graphics/Typeface;
    ...
    iput p1, p0, Landroid/support/design/widget/d;->G:F
    ...
    .line 653
    iget p1, p0, Landroid/support/design/widget/d;->H:F

    cmpl-float p1, p1, v2

    if-nez p1, :cond_7

    iget-boolean p1, p0, Landroid/support/design/widget/d;->J:Z
    ...
    .line 654
    :goto_5
    iput v2, p0, Landroid/support/design/widget/d;->H:F

    .line 655
    iput-boolean v5, p0, Landroid/support/design/widget/d;->J:Z

    .line 658
    :cond_8
    iget-object p1, p0, Landroid/support/design/widget/d;->z:Ljava/lang/CharSequence;
    ...
    .line 659
    :cond_9
    iget-object p1, p0, Landroid/support/design/widget/d;->K:Landroid/text/TextPaint;

    iget v1, p0, Landroid/support/design/widget/d;->H:F
    ...
    .line 668
    iput-object p1, p0, Landroid/support/design/widget/d;->z:Ljava/lang/CharSequence;

    .line 669
    iget-object p1, p0, Landroid/support/design/widget/d;->z:Ljava/lang/CharSequence;

    invoke-direct {p0, p1}, Landroid/support/design/widget/d;->a(Ljava/lang/CharSequence;)Z
...
.method private e()V
    ...
    iget-object v8, p0, Landroid/support/design/widget/d;->K:Landroid/text/TextPaint;
...
.method public calculateCollapsedTextWidth()F
    ...
    .line 192
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/d;->L:Landroid/text/TextPaint;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v1, p0, Landroid/support/design/widget/d;->e:Z

    if-eqz v1, :cond_5

    .line 538
    iget v6, p0, Landroid/support/design/widget/d;->t:F

    .line 539
    iget v1, p0, Landroid/support/design/widget/d;->u:F

    .line 541
    iget-boolean v2, p0, Landroid/support/design/widget/d;->B:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/design/widget/d;->C:Landroid/graphics/Bitmap;
    ...
    iget v4, p0, Landroid/support/design/widget/d;->G:F
    ...
    iget-object v2, p0, Landroid/support/design/widget/d;->D:Landroid/graphics/Paint;
...
.method public getCollapsedTextActualBounds(Landroid/graphics/RectF;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/design/widget/d;->a(Ljava/lang/CharSequence;)Z
    ...
    .line 206
    invoke-virtual {p0}, Landroid/support/design/widget/d;->calculateCollapsedTextWidth()F
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/d;->getCollapsedTextHeight()F
...
.method public recalculate()V
    ...
    .line 705
    invoke-direct {p0}, Landroid/support/design/widget/d;->d()V
...
.method public setCollapsedBounds(IIII)V
    ...
    .line 183
    iput-boolean p1, p0, Landroid/support/design/widget/d;->J:Z
...
.method public setCollapsedTextAppearance(I)V
    ...
    sget-object v1, Landroid/support/v7/a/a$l;->TextAppearance:[I

    .line 249
    invoke-static {v0, p1, v1}, Landroid/support/v7/widget/ay;->obtainStyledAttributes(Landroid/content/Context;I[I)Landroid/support/v7/widget/ay;

    move-result-object v0

    .line 251
    sget v1, Landroid/support/v7/a/a$l;->TextAppearance_android_textColor:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ay;->hasValue(I)Z
    ...
    .line 253
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ay;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    .line 256
    :cond_0
    sget v1, Landroid/support/v7/a/a$l;->TextAppearance_android_textSize:I
    ...
    .line 258
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ay;->getDimensionPixelSize(II)I
    ...
    .line 262
    :cond_1
    sget v1, Landroid/support/v7/a/a$l;->TextAppearance_android_shadowColor:I

    const/4 v2, 0x0

    .line 263
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ay;->getInt(II)I

    move-result v1

    iput v1, p0, Landroid/support/design/widget/d;->R:I

    .line 264
    sget v1, Landroid/support/v7/a/a$l;->TextAppearance_android_shadowDx:I

    const/4 v2, 0x0

    .line 265
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ay;->getFloat(IF)F
    ...
    .line 266
    sget v1, Landroid/support/v7/a/a$l;->TextAppearance_android_shadowDy:I
    ...
    .line 268
    sget v1, Landroid/support/v7/a/a$l;->TextAppearance_android_shadowRadius:I
    ...
    .line 273
    invoke-direct {p0, p1}, Landroid/support/design/widget/d;->a(I)Landroid/graphics/Typeface;
    ...
    .line 276
    :cond_2
    invoke-virtual {p0}, Landroid/support/design/widget/d;->recalculate()V
...
.method public setExpandedTextAppearance(I)V
    ...
    iput v1, p0, Landroid/support/design/widget/d;->V:I
    ...
    iput v1, p0, Landroid/support/design/widget/d;->U:F
...
.method public setPositionInterpolator(Landroid/animation/TimeInterpolator;)V
    ...
    .line 140
    iput-object p1, p0, Landroid/support/design/widget/d;->M:Landroid/animation/TimeInterpolator;
...
.method public setTextSizeInterpolator(Landroid/animation/TimeInterpolator;)V
    ...
    .line 135
    iput-object p1, p0, Landroid/support/design/widget/d;->N:Landroid/animation/TimeInterpolator;
