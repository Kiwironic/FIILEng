...
.method public constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    .line 1960
    iput v0, p0, Landroid/support/design/widget/TabLayout$g;->i:I

    .line 1964
    invoke-direct {p0, p2}, Landroid/support/design/widget/TabLayout$g;->a(Landroid/content/Context;)V
    ...
    .line 1967
    invoke-virtual {p0, p2}, Landroid/support/design/widget/TabLayout$g;->setGravity(I)V
    ...
    .line 1969
    invoke-virtual {p0, p2}, Landroid/support/design/widget/TabLayout$g;->setClickable(Z)V
...
.method static synthetic a(Landroid/support/design/widget/TabLayout$g;)I
    .locals 0

    .line 1950
    invoke-direct {p0}, Landroid/support/design/widget/TabLayout$g;->d()I
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v7/c/a/a;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Landroid/support/design/widget/TabLayout$g;->h:Landroid/graphics/drawable/Drawable;

    .line 1977
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$g;->h:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$g;->getDrawableState()[I
    ...
    .line 1981
    :cond_0
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$g;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 1997
    invoke-static {v3}, Landroid/support/design/f/a;->convertToRippleDrawableColor(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    .line 2030
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$g;->h:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$g;->getLeft()I

    move-result v1

    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$g;->getTop()I

    move-result v2

    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$g;->getRight()I

    move-result v3

    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$g;->getBottom()I
...
.method static synthetic a(Landroid/support/design/widget/TabLayout$g;Landroid/content/Context;)V
    .locals 0

    .line 1950
    invoke-direct {p0, p1}, Landroid/support/design/widget/TabLayout$g;->a(Landroid/content/Context;)V

    return-void
.end method

.method static synthetic a(Landroid/support/design/widget/TabLayout$g;Landroid/graphics/Canvas;)V
    .locals 0

    .line 1950
    invoke-direct {p0, p1}, Landroid/support/design/widget/TabLayout$g;->a(Landroid/graphics/Canvas;)V
...
.method private a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 2279
    iget-object v0, p0, Landroid/support/design/widget/TabLayout$g;->b:Landroid/support/design/widget/TabLayout$f;
    ...
    .line 2283
    :goto_0
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$g;->b:Landroid/support/design/widget/TabLayout$f;
    ...
    :cond_8
    :goto_5
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$g;->b:Landroid/support/design/widget/TabLayout$f;
    ...
    .line 2335
    :cond_a
    invoke-static {p0, p1}, Landroid/support/v7/widget/ba;->setTooltipText(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method a()V
    ...
    .line 2178
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout$g;->a(Landroid/support/design/widget/TabLayout$f;)V
...
.method a(Landroid/support/design/widget/TabLayout$f;)V
    ...
    .line 2172
    iput-object p1, p0, Landroid/support/design/widget/TabLayout$g;->b:Landroid/support/design/widget/TabLayout$f;
...
.method final b()V
    ...
    .line 2203
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$g;->f:Landroid/widget/TextView;
    ...
    iput v3, p0, Landroid/support/design/widget/TabLayout$g;->i:I
    ...
    sget v4, Landroid/support/design/a$k;->design_layout_tab_icon:I
    ...
    .line 2224
    invoke-virtual {p0, v2, v3}, Landroid/support/design/widget/TabLayout$g;->addView(Landroid/view/View;I)V

    .line 2225
    iput-object v2, p0, Landroid/support/design/widget/TabLayout$g;->d:Landroid/widget/ImageView;
    ...
    sget v2, Landroid/support/design/a$k;->design_layout_tab_text:I
    ...
    iput v1, p0, Landroid/support/design/widget/TabLayout$g;->i:I
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/design/widget/TabLayout$g;->a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/design/widget/TabLayout$g;->setContentDescription(Ljava/lang/CharSequence;)V
    ...
    :cond_11
    invoke-virtual {p0, v3}, Landroid/support/design/widget/TabLayout$g;->setSelected(Z)V
...
.method final c()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/TabLayout$g;->setOrientation(I)V
...
.method protected drawableStateChanged()V
    ...
    .line 2041
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$g;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 2046
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$g;->invalidate()V
...
.method public getTab()Landroid/support/design/widget/TabLayout$f;
    .locals 1
...
.method public onMeasure(II)V
    ...
    .line 2129
    iget v1, p0, Landroid/support/design/widget/TabLayout$g;->i:I
...
.method public performClick()Z
    ...
    .line 2055
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$g;->b:Landroid/support/design/widget/TabLayout$f;
